...
const About = () => {
    return (
        <div className=' py-20 overflow-x-hidden'>
            <h1 className='text-[50px] font-[700] mb-10'>Learn more about <span className='text-[#EA4722] '>what we solve</span></h1>

            <div className='flex sm:flex gap-20 overflow-x-auto py-10 about-card-wrapper'>
                {
                    aboutCards.map((item) => {
                        return <div key={item.id} className='min-w-110 p-5 about-cards'>
